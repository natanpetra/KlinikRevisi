...
{
    private $route = 'history/history-reservation';
    private $routeView = 'history.history-reservation';
    private $routeUpload = 'img/reservation';
    private $params = [];
    ...
    {
      $this->params['reservations'] = $this->model->with('user')->get();
    ...
    public function updateNote(Request $request, Reservation $reservation)
    {
        ...
        $reservation->update(['doctor_notes'=>$request->note]);
