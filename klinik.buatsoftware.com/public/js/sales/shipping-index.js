...
$(".has-ajax-form").click(function() {
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            $('input[name="instruction_date"]').val(response.instruction_date_formated);
            $('input[name="instruction_number"]').val(response.instruction_number);
            ...
            (response.good_receipt_id) ?
                select2AjaxHandler('select[name="good_receipt_id"]', `${baseBeApiUrl}/production/good-receipt`, response.good_receipt_id, true) :
                select2AjaxHandler('select[name="sales_id"]', `${baseBeApiUrl}/sales/order/shipping`, response.sales_id, true);
