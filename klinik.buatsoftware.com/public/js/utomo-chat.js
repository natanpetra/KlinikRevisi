...
var axiosRequest = axios.create({
  baseURL: "https://utomodeck-erp.site/ajax"
});
...
var appChat = new Vue({
  el: '#vue-chat-element',
  mounted: function mounted() {// this.fetchInbox()
    // let self = this
  ...
  computed: {
    isOpenInbox: function isOpenInbox() {
      return Object.entries(this.inboxContentHeader).length !== 0;
    },
    reverseInboxContent: function reverseInboxContent() {
  ...
  methods: {
    ...
    sendMessage: function sendMessage() {
      ...
      axiosRequest.post("/customer-chat/".concat(this.inboxContentHeader.id, "/message"), params).then(function (response) {
        var updateInboxContent = [response.data];
        updateInboxContent.push.apply(updateInboxContent, _toConsumableArray(_this.inboxContent));
        _this.inboxContent = updateInboxContent;
    ...
    toLastMessage: function toLastMessage() {
      this.$nextTick(function () {
        var lastMessage = this.$refs.msg_history.lastElementChild;
        this.$refs.msg_history.scrollTop = lastMessage.offsetTop;
      });
    },
    openInbox: function openInbox(id) {
      if (this.inboxContentHeader.id === id) return;
      this.inboxContentHeader = this.inbox.find(function (ibx) {
        return ibx.id === id;
      });
      this.inboxContentPage.current_page = 0;
      this.inboxContent = [];
    },
    fetchInboxContent: function fetchInboxContent($state) {
      var _this2 = this;

      var page = this.inboxContentPage.current_page + 1;
      axiosRequest.get("/customer-chat/".concat(this.inboxContentHeader.id, "/message?page=").concat(page)).then(function (response) {
        if (response.data.data.length) {
          var _this2$inboxContent;

          (_this2$inboxContent = _this2.inboxContent).push.apply(_this2$inboxContent, _toConsumableArray(response.data.data));

          _this2.inboxContentPage = response.data;
          delete _this2.inboxContentPage.data;
          $state.loaded();
          if (page === 1) _this2.toLastMessage();
          return;
        }
    ...
    fetchInbox: function fetchInbox($state) {
      var _this3 = this;

      var page = this.inboxPage.current_page + 1;
      axiosRequest.get("/customer-chat?page=".concat(page)).then(function (response) {
        if (response.data.data.length) {
          var _this3$inbox;

          (_this3$inbox = _this3.inbox).push.apply(_this3$inbox, _toConsumableArray(response.data.data));

          _this3.inboxPage = response.data;
          delete _this3.inboxPage.data;
          $state.loaded();
          return;
        }
...
/***/ 0:
/*!****************************************!*\
  !*** multi ./resources/js/app-chat.js ***!
  \****************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

module.exports = __webpack_require__(/*! F:\xampp73\htdocs\my-projects\utomodeck-erp-new\resources\js\app-chat.js */"./resources/js/app-chat.js");
