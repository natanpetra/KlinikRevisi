function updateClock() {
    ...
    //Add into element
    document.querySelector('#beranda_time').innerText = time
}
...
function displayDate() {
    ...
    // Get the month (0-11)
    const month = now.getMonth() < 10 ? '0' + (now.getMonth() + 1) : (now.getMonth() + 1).toString();
    ...
    document.getElementById('beranda_date').textContent = fullDate;
}
